...
public class CheckoutPage extends BasePage {
    ...
    public void fillBillingDetails() {
        ...
        sendKeys(firstName, "Samanvitha");
        sendKeys(lastName, "Nadella");
        sendKeys(email, "test" + System.currentTimeMillis() + "@mail.com");
        sendKeys(telephone, "9014936127");
        sendKeys(address1, "Vijayawada");
        sendKeys(city, "Vijayawada");
        sendKeys(postcode, "520008");
